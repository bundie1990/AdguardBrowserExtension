...
adguard.frames = (function (adguard) {
     ...
     */
    const isTabAdguardDetected = function (tab) {
    ...
    const isTabAdguardWhiteListed = function (tab) {
        ...
        const adguardDocumentWhiteListed = adguard.tabs.getTabMetadata(tab.tabId, 'adguardDocumentWhiteListed');
     ...
     */
    const recordAdguardIntegrationForTab = function (
        tab,
        adguardDetected,
        documentWhiteListed,
        userWhiteListed,
     ...
     * @returns {boolean}
     */
    const shouldStopRequestProcess = (tab) => isTabAdguardDetected(tab)
