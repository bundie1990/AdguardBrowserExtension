 ...
 * Context contains information about this request: id, url, referrer, type, applied rules,
 * original and modified headers
 *
...
(function (adguard) {
     ...
     */
    const get = (requestId) => contexts.get(requestId);
