...
(function (adguard, api) {
    ...
    function parseRuleDomain(ruleText, parseOptions) {
        try {
            ...
            for (i = 0; i < startsWith.length; i += 1) {
            ...
            switch (optionName) {
                ...
                case UrlFilterRule.BADFILTER_OPTION:
                    this.badFilter = this.ruleText
                        .replace(UrlFilterRule.OPTIONS_DELIMITER
                            + UrlFilterRule.BADFILTER_OPTION
                            + api.FilterRule.COMA_DELIMITER, UrlFilterRule.OPTIONS_DELIMITER)
                ...
                default:
                    ...
                    } else if (optionName[0] === api.FilterRule.NOT_MARK
