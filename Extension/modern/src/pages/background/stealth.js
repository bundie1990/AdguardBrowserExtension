...
adguard.stealthService = (function (adguard) {
     ...
     * @returns {boolean}
     */
    const isStealthModeDisabled = () => adguard.settings.getProperty(adguard.settings.DISABLE_STEALTH_MODE)
     ...
     * @returns {boolean}
     */
    const canBlockWebRTC = () => !adguard.utils.browser.isEdgeBrowser();
     ...
     * @returns {boolean}
     */
    const shouldHandlePrivacyPermission = () => adguard.utils.browser.isChromium();
